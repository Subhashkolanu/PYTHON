...
Radiobutton(r,text="Chandrababu Naidu",variable=rv,value="Chandrababu naidu").pack()
Radiobutton(r,text="Jaganmohan Reddy",variable=rv,value="Jaganmohan Reddy").pack()
